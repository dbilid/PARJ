...
public class AdpDBSelectOperator implements Serializable {
	...
	public static BitSet findCommonPartitions(AdpDBSelectOperator from, AdpDBSelectOperator to, String table) {
	...
	private void addPartition(String table, int partition, HashMap<String, HashMap<Integer, Integer>> tablesIO) {
	...
	private HashMap<Integer, Integer> getOrCreate(String table, HashMap<String, HashMap<Integer, Integer>> tablesIO) {
	...
	public String toString() {
		return "AdpDBSelectOperator{" + "type=" + type + ", query=" + query + ", serialNumber=" + serialNumber
				+ ", totalInputs=" + totalInputs + ", inputs=" + inputs + ", totalOutputs=" + totalOutputs
				+ ", outputs=" + outputs + '}';
	}
}
