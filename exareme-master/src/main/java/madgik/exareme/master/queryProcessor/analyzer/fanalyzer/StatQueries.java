...
public class StatQueries {
	...
	public int computeColumnSize(String columnName, int columnType, String table_sample) throws Exception {
		int columnSize = 0;
	...
	public int computeValOccurences(String tableName, String columnName, String value) throws Exception {
	...
	public List<ValFreq> computeDistinctValuesFrequency(String table_sample, String columnName) throws Exception {
