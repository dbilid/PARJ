...
public class WhereClauseVisitor extends AbstractVisitor {
	...
	/*
	 * public boolean nestedJoins(Visitable node){ if(!(node instanceof
	 * JoinNode)) return false; JoinNode j=(JoinNode) node;
	 * if(j.getLeftResultSet() instanceof JoinNode || j.getRightResultSet()
	 * instanceof JoinNode) return true; return false; }
	 */
}
